...
//Escuchamos estado-actual
socket.on("estado-actual", (payload) => {
	const audio = new Audio("./audio/new-ticket.mp3");
	audio.play();

	//Desestrucutramos del payload 4 tickets
	const [ticket1, ticket2, ticket3, ticket4] = payload;

	//Si cada ticket existe entonces le cambia los valores a los elementos html por los valores que acabamos de desestructurar
	if (ticket1) {
